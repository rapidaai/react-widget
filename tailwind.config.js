...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      base: ["0.90rem", { lineHeight: "1.40rem" }],
      lg: ["1.025rem", { lineHeight: "1.65rem" }],
      xl: ["1.15rem", { lineHeight: "1.65rem" }],
      "2xl": ["1.40rem", { lineHeight: "1.90rem" }],
      "3xl": ["1.775rem", { lineHeight: "2.15rem" }],
      "4xl": ["2.15rem", { lineHeight: "2.40rem" }],
      "5xl": ["2.90rem", { lineHeight: "0.90rem" }],
      "6xl": ["3.65rem", { lineHeight: "0.90rem" }],
      "7xl": ["4.40rem", { lineHeight: "0.90rem" }],
      "8xl": ["5.90rem", { lineHeight: "0.90rem" }],
      "9xl": ["7.90rem", { lineHeight: "0.90rem" }],
    },
    fontWeight: {
      thin: "100",
      extralight: "200",
    ...
    keyframes: {
      ...
      bounceCustom: {
        ...
        "50%": { transform: "translateY(-70%)" }, // Adjust the bounce height here
      },
    },
    letterSpacing: {
      tighter: "-0.05em",
