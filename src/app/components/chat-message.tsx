...
export const SystemChatMessage: FC<{
  ...
  return (
    <div className="pks_flex pks_px-2 pks_group pks_justify-start pks_items-start pks_gap-2">
      <div className="pks_h-12 pks_w-12 pks_flex-shrink-0 pks_flex pks_items-center pks_justify-center pks_bg-gray-200/20 pks_order-1 pks_border-[0.5px] pks_rounded-full">
      ...
      <div className="pks_min-w-0 pks_order-2">
        <div className="pks_border-[0.5px] pks_rounded-[18px] pks_bg-gray-200/20">
          ...
          <div className="pks_flex pks_w-full pks_py-2 pks_px-4 pks_space-x-1 pks_mt-3 pks_rounded-b-[18px] pks_justify-end pks_border-t-[0.5px]">
            <CopyButton
